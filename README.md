...
<img width="950" alt="image" src="https://github.com/user-attachments/assets/d58681b7-1a4e-41b4-8f5b-88563c0eb11a" />
...
# Key Insight:
  ...
  •	Category-Content Consistency:
   ...
   =>	For the animal category, photos and audio dominated engagement.
   
   => For science, photos and videos were the top contributors.
   
   =>	Food showed consistent engagement across all content types.
   
   =>	For healthy eating, audio & video were dominating content type
   
   =>	For technology audio & gif were in the top.
